...
<?php $this->start('main_content') ?>
    ...
    <!-- Début de la section -->
    <section class="hidden-sm hidden-md hidden-lg hidden-lg">
        <h2>Propositions de parcours</h2>
        <div class="container">
            <div class="row">
            
                <!-- Carousel Bootstrap -->
                <div id="carousel-example-generic" class="carousel slide mobile">
                    ...
                    <!-- Fin de la rangée de l'enveloppe -->
                    </div>                    
                <!-- Fin du carousel -->
                </div>
<<<<<<< HEAD
